...
var imgParallax = {
  ...
  sxAnimate: function sxAnimate(box, boxW, sW, sOffsetArrL, sImgArr) {
  ...
  setupTwo: function setupTwo() {
    var _this = this;

    // forEach gallery element
    ...
    allGalleries.forEach(function (sBox) {
      var box = sBox;
      var sArr = [].slice.call(box.querySelectorAll("figure"));
      var sImgArr = [].slice.call(box.querySelectorAll("figure img, figure iframe")); // iframe is for sample code
      ...
      if (flexDir === "row") {
        ...
        _this.forEventListener = function () {
  ...
  setupOne: function setupOne() {
    // first run and initial css setup
    var resizeDone;
    window.addEventListener("resize", function () {
